            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StateId = table.Column<int>(name: "State Id", type: "INT", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StateName = table.Column<string>(name: "State Name", type: "Nvarchar(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CityId = table.Column<int>(name: "City Id", type: "INT", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CityName = table.Column<string>(name: "City Name", type: "Nvarchar(100)", nullable: false),
